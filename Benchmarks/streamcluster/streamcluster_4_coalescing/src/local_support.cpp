...
#define I_KMAX 10
#define I_KMIN 20 // 30
#define I_DIM 256 // 200
#define I_N  65536 // 8192
// #define BATCH_SIZE 65536 // 1024
#define I_CLUSTER_SIZE 1000
...
void run_benchmark( void *vargs, cl_context& context, cl_command_queue& commands, cl_program& program, cl_kernel& kernel ) {
  ...
  struct bench_args_t *args = (struct bench_args_t *)vargs;
    ...
    streamCluster(stream, I_KMIN, I_KMAX, I_DIM, I_CLUSTER_SIZE, outfilename, context, commands, kernel);
